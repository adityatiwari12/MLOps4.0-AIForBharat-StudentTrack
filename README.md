...
```mermaid
gantt
    title Dharohar Development Roadmap
    dateFormat  YYYY-MM-DD
    section Core Features
    Authentication & User Management           :a1, 2026-01-28, 3d
    Heritage-Bio Service                       :a2, after a1, 5d
    Heritage-Sonic Service                     :a3, after a2, 4d
    Digital Passport Service                   :a4, after a3, 3d
    section Advanced Features
    Sovereignty Vault (QLDB)                   :b1, after a4, 4d
    Expert Verification Workflow               :b2, after b1, 3d
    License Marketplace                        :b3, after b2, 5d
    section Polish
    Mobile App UI/UX                           :c1, after b3, 4d
    Testing & QA                               :c2, after c1, 3d
    Performance Optimization                   :c3, after c2, 2d
    Demo Preparation                           :c4, after c3, 2d
```
